...
export PARENT_URL=http://simvascular.stanford.edu/downloads/public/simvascular/externals/darwin/mac_osx/10.11/clang/7.3/x64/RelWithDebInfo/2016.09.05
                       
export TAR_FILE_PREFIX=mac_osx.10.11.clang.7.3.x64.RelWithDebInfo.2016.09.05
