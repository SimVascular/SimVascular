...
VTK_BINDIR = $(OPEN_SOFTWARE_BINARIES_TOPLEVEL)/vtk-6.2.0-tcltk-8.6-python2.7
VTK_LIBDIRS = $(VTK_BINDIR)/lib
VTK_BINDIRS = $(VTK_BINDIR)/bin
VTK_SO_PATH = $(VTK_LIBDIRS)
VTK_DLLS    = $(VTK_BINDIRS)/*.$(SOEXT)

VTK_SYS_LIBS  = -lpthread -lm -ldl

VTK_INCDIRS = \
-I$(VTK_SRCDIR)/Wrapping/PythonCore \
-I$(VTK_BINDIR)/Wrapping/PythonCore \
-I$(VTK_SRCDIR)/Utilities/Python \
-I$(VTK_BINDIR)/Utilities/Python \
...
VTK_LIBS +=     $(LIBPATH_COMPILER_FLAG)$(VTK_LIBDIRS) \
		$(LIBFLAG)vtkWrappingPython27Core-6.2$(LIBLINKEXT) \
