ifeq ($(CLUSTER), x64_osx)
    ITK_SRC_DIR	= $(OPEN_SOFTWARE_SOURCES_TOPLEVEL)/itk-4.8.2
    ITK_BIN_DIR = $(OPEN_SOFTWARE_BINARIES_TOPLEVEL)/itk-4.8.2
...
$(LIBFLAG)itkgdcmCommon-4.8$(LIBLINKEXT)  $(LIBFLAG)itkgdcmuuid-4.8$(LIBLINKEXT)        \
