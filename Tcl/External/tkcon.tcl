...
#  NOTE:  This tkcon is slightly modified in two places to enable
#         embedding of tkcon console into packed window.
#
#         The modifications are clearly marked "modified
#         by Cardiovacular Simulation Inc."
#
#         Originall code is Rev. 1.102 from sourceforge.net repository.
#
...
###  end modification by Cardiovascular Simulation Inc
    if {!$PRIV(WWW)} {
	wm withdraw $root
...
### begin modification by Cardiovascular Simulation Inc.
