...
const QString QmitkAutocrop::EXTENSION_ID = "mitk.autocrop";

QmitkAutocrop::QmitkAutocrop()
{
    QmitkNodeDescriptor* dataNodeDescriptor = getNodeDescriptorManager()->GetDescriptor("ImageMask");
    QAction* action = new QAction(QIcon(":xxx.png"), "Autocrop", this);
    QObject::connect( action, SIGNAL( triggered() ) , this, SLOT( Exec() ) );
...
void QmitkAutocrop::Exec()
{
    Crop(GetCurrentSelection());
}

void QmitkAutocrop::Crop( const QList<mitk::DataNode::Pointer> &selectedNodes )
...
mitk::Image::Pointer QmitkAutocrop::IncreaseCroppedImageSize( mitk::Image::Pointer image )
{
