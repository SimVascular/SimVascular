...
vtkStandardNewMacro(vtkDelaunay2D_60);
vtkCxxSetObjectMacro(vtkDelaunay2D_60,Transform,vtkAbstractTransform);

// Construct object with Alpha = 0.0; Tolerance = 0.00001; Offset = 1.25;
// BoundingTriangulation turned off.
vtkDelaunay2D_60::vtkDelaunay2D_60()
{
  this->Alpha = 0.0;
...
void vtkDelaunay2D_60::SetSourceData(vtkPolyData *input)
{
...
void vtkDelaunay2D_60::SetSourceConnection(vtkAlgorithmOutput *algOutput)
{
  this->Superclass::SetInputConnection(1, algOutput);
}

vtkPolyData *vtkDelaunay2D_60::GetSource()
{
...
int vtkDelaunay2D_60::InCircle (double x[3], double x1[3], double x2[3],
                             double x3[3])
{
...
vtkIdType vtkDelaunay2D_60::FindTriangle(double x[3], vtkIdType ptIds[3],
...
// triangle id.
void vtkDelaunay2D_60::CheckEdge(vtkIdType ptId, double x[3], vtkIdType p1,
...
//
int vtkDelaunay2D_60::RequestData(
...
int *vtkDelaunay2D_60::RecoverBoundary(vtkPolyData *source)
{
...
int vtkDelaunay2D_60::RecoverEdge(vtkIdType p1, vtkIdType p2)
{
  vtkIdType cellId = 0;
  int i, j, k;
...
void vtkDelaunay2D_60::FillPolygons(vtkCellArray *polys, int *triUse)
{
...
//----------------------------------------------------------------------------
int vtkDelaunay2D_60::FillInputPortInformation(int port, vtkInformation* info)
{
  if (port == 0)
    {
...
//----------------------------------------------------------------------------
vtkAbstractTransform * vtkDelaunay2D_60::ComputeBestFittingPlane(
  vtkPointSet *input)
{
...
//----------------------------------------------------------------------------
void vtkDelaunay2D_60::PrintSelf(ostream& os, vtkIndent indent)
{
