/*=========================================================================
  ...
  Module:    vtkLocalButterflySubdivisionFilter.cxx
...
vtkStandardNewMacro(vtkLocalButterflySubdivisionFilter);

static double butterflyWeights[8] =
  {.5, .5, .125, .125, -.0625, -.0625, -.0625, -.0625};

int vtkLocalButterflySubdivisionFilter::GenerateSubdivisionPoints(
...
void vtkLocalButterflySubdivisionFilter::GenerateLoopStencil(
...
void vtkLocalButterflySubdivisionFilter::GenerateBoundaryStencil(
  vtkIdType p1, vtkIdType p2, vtkPolyData *polys, vtkIdList *stencilIds,
  double *weights)
{
  vtkIdList *cellIds = vtkIdList::New();
...
void vtkLocalButterflySubdivisionFilter::GenerateButterflyStencil (
  vtkIdType p1, vtkIdType p2, vtkPolyData *polys, vtkIdList *stencilIds,
  double *weights)
{
  vtkIdList *cellIds = vtkIdList::New();
...
int vtkLocalButterflySubdivisionFilter::SetFixedCells(vtkPolyData *pd, int *noSubdivideCell)
{
