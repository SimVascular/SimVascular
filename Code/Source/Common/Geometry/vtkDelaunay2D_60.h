...
=========================================================================*/
// .NAME vtkDelaunay2D_60 - create 2D Delaunay triangulation of input points
// .SECTION Description
// vtkDelaunay2D_60 is a filter that constructs a 2D Delaunay triangulation from
...
class SV_EXPORT_SYSGEOM vtkDelaunay2D_60 : public vtkPolyDataAlgorithm
{
public:
