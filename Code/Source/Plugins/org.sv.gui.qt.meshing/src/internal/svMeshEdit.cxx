...
void svMeshEdit::CreatePartControl(QWidget* parent)
{
  // scrollArea
...
void svMeshEdit::AfterCreateQtPartControl()
{
  ...
  m_BlueBerrySelectionListener.reset(new berry::SelectionChangedAdapter<svMeshEdit>(
                                       this,
                                       &svMeshEdit::BlueBerrySelectionChanged)
                                     );
...
void svMeshEdit::BlueBerrySelectionChanged(const berry::IWorkbenchPart::Pointer& sourcepart,
...
void svMeshEdit::ClosePartProxy()
{
