...
class QmitkSegmentationView : public svAbstractView
{
    Q_OBJECT
...
protected:
    ...
    // propagate selection to ToolManager for manual segmentation
    ...
    // ATTENTION these methods are defined in svQmitkSegmentationOrganNamesHandling.cxx
