...
void svModelEdit::CreatePartControl(QWidget* parent)
{
  // scrollArea
...
void svModelEdit::AfterCreateQtPartControl()
{
  ...
  m_BlueBerrySelectionListener.reset(new berry::SelectionChangedAdapter<svModelEdit>(
                                       this,
                                       &svModelEdit::BlueBerrySelectionChanged)
                                     );
...
void svModelEdit::BlueBerrySelectionChanged(const berry::IWorkbenchPart::Pointer& sourcepart,
...
void svModelEdit::ClosePartProxy()
{
