...
const QString QmitkBasicImageProcessingView::EXTENSION_ID = "mitk.basicimageprocessing";

QmitkBasicImageProcessingView::QmitkBasicImageProcessingView()
: m_Controls(NULL),
...
void QmitkBasicImageProcessingView::CreateQtPartControl(QWidget *parent)
{
  if (m_Controls == NULL)
  {
  ...
  QAction* bpAction = new QAction(QIcon(":ImageProcessing.xpm"), "Basic Processing", this);
  QObject::connect( bpAction, SIGNAL( triggered() ) , this, SLOT( ShowBasicImageProcessingPane() ) );
  imageDataNodeDescriptor->AddAction(bpAction,false);
  mDescriptorActionList.push_back(std::pair<QmitkNodeDescriptor*, QAction*>(imageDataNodeDescriptor, bpAction));

  Activated();
}

void QmitkBasicImageProcessingView::CreateConnections()
{
  if ( m_Controls )
  {
  ...
  m_TimeStepperAdapter = new QmitkStepperAdapter((QObject*) m_Controls->sliceNavigatorTime,
    GetDisplayWidget()->GetTimeNavigationController()->GetTime(), "sliceNavigatorTimeFromBIP");
}

void QmitkBasicImageProcessingView::Activated()
{
...
void QmitkBasicImageProcessingView::OnSelectionChanged(const QList<mitk::DataNode::Pointer>& nodes )
//void QmitkBasicImageProcessingView::OnSelectionChanged(std::vector<mitk::DataNode*> nodes)
{
  //any nodes there?
  if (!nodes.empty())
  {
...
void QmitkBasicImageProcessingView::ChangeGUI()
{
...
void QmitkBasicImageProcessingView::ResetOneImageOpPanel()
{
...
void QmitkBasicImageProcessingView::ResetParameterPanel()
{
...
void QmitkBasicImageProcessingView::ResetTwoImageOpPanel()
{
...
void QmitkBasicImageProcessingView::SelectAction(int action)
{
...
void QmitkBasicImageProcessingView::StartButtonClicked()
{
  if(!m_SelectedImageNode->GetNode()) return;
...
void QmitkBasicImageProcessingView::SelectAction2(int operation)
{
  // check which operation the user has selected and set parameters and GUI accordingly
  switch (operation)
  {
...
void QmitkBasicImageProcessingView::StartButton2Clicked()
{
...
void QmitkBasicImageProcessingView::SelectInterpolator(int interpolator)
{
  switch (interpolator)
  {
  case 0:
...
void QmitkBasicImageProcessingView::ShowBasicImageProcessingPane()
{
