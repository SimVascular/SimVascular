...
svWorkbenchIntroPart::svWorkbenchIntroPart()
    : m_Controls(nullptr)
{
    berry::IPreferences::Pointer workbenchPrefs = svApplicationPluginActivator::GetDefault()->GetPreferencesService()->GetSystemPreferences();
...
void svWorkbenchIntroPart::CreateConnections()
{
    if ( m_Controls )
    {
...
void svWorkbenchIntroPart::DelegateMeTo(const QUrl& showMeNext)
{
...
void svWorkbenchIntroPart::StandbyStateChanged(bool /*standby*/)
{

}


void svWorkbenchIntroPart::SetFocus()
{
