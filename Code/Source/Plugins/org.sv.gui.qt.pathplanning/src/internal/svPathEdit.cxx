...
void svPathEdit::CreatePartControl(QWidget* parent)
{
  // scrollArea
...
void svPathEdit::AfterCreateQtPartControl()
{
  ...
  m_BlueBerrySelectionListener.reset(new berry::SelectionChangedAdapter<svPathEdit>(
                                       this,
                                       &svPathEdit::BlueBerrySelectionChanged)
                                     );
...
void svPathEdit::BlueBerrySelectionChanged(const berry::IWorkbenchPart::Pointer& sourcepart,
...
void svPathEdit::ClosePartProxy()
{
