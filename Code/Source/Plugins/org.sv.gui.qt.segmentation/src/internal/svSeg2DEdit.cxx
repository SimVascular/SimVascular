...
void svSeg2DEdit::CreatePartControl(QWidget* parent)
{
  // scrollArea
...
void svSeg2DEdit::AfterCreateQtPartControl()
{
  ...
  m_BlueBerrySelectionListener.reset(new berry::SelectionChangedAdapter<svSeg2DEdit>(
                                       this,
                                       &svSeg2DEdit::BlueBerrySelectionChanged)
                                     );
...
void svSeg2DEdit::BlueBerrySelectionChanged(const berry::IWorkbenchPart::Pointer& sourcepart,
...
void svSeg2DEdit::ClosePartProxy()
{
