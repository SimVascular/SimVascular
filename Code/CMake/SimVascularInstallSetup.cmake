...
if(NOT SV_INSTALL_OPENCASCADE_LIBRARY_DIR)
  set(SV_INSTALL_OPENCASCADE_LIBRARY_DIR vtk/lib)
endif()
mark_as_superbuild(SV_INSTALL_OPENCASCADE_LIBRARY_DIR:PATH)

if(NOT SV_INSTALL_OPENCASCADE_ARCHIVE_DIR)
  set(SV_INSTALL_OPENCASCADE_ARCHIVE_DIR vtk/lib)
endif()
mark_as_superbuild(SV_INSTALL_OPENCASCADE_ARCHIVE_DIR:PATH)

if(NOT SV_INSTALL_OPENCASCADE_INCLUDE_DIR)
  set(SV_INSTALL_OPENCASCADE_INCLUDE_DIR vtk/include)
endif()
