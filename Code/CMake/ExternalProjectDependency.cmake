	...
	if(EXISTS ${binary_dir}/bin)
	  install(DIRECTORY ${binary_dir}/bin DESTINATION Externals)
        ...
        if(EXISTS ${SV_${proj}_DIR}/lib)
          install(DIRECTORY ${SV_${proj}_DIR}/lib DESTINATION Externals/${SV_EXT_${project_name}_BIN_DIR})
	endif()
        if(EXISTS ${SV_${proj}_DIR}/bin)
          install(DIRECTORY ${SV_${proj}_DIR}/bin DESTINATION Externals/${SV_EXT_${project_name}_BIN_DIR})
	endif()
        if(EXISTS ${SV_${proj}_DIR}/include)
          install(DIRECTORY ${SV_${proj}_DIR}/include DESTINATION Externals/${SV_EXT_${project_name}_BIN_DIR})
	endif()
      endif()
    endif()
  endif()
...
function(ExternalProject_Install_CMake_NoSB project_name)
  ...
  if(NOT "${SV_${proj}_DIR}" STREQUAL "")
    if(${CMAKE_PROJECT_NAME}_ENABLE_DISTRIBUTION)
      if(EXISTS ${SV_${proj}_DIR}/lib)
        install(DIRECTORY ${SV_${proj}_DIR}/lib DESTINATION Externals)
      endif()
      if(EXISTS ${SV_${proj}_DIR}/bin)
        install(DIRECTORY ${SV_${proj}_DIR}/bin DESTINATION Externals)
      endif()
    else()
      if(EXISTS ${SV_${proj}_DIR}/lib)
        install(DIRECTORY ${SV_${proj}_DIR}/lib DESTINATION Externals/${SV_EXT_${project_name}_BIN_DIR})
