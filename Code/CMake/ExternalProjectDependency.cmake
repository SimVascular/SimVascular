...
function(ExternalProject_Install_CMake project_name)
  ...
  if("${project_name}" STREQUAL "${CMAKE_PROJECT_NAME}")
    ...
    set(TEST_DIR ${SV_EXTERNALS_TOPLEVEL_DIR}/${SV_EXT_${proj}_BIN_DIR})
	...
	if(EXISTS ${binary_dir}/bin)
	  install(DIRECTORY ${binary_dir}/bin DESTINATION Externals)
        endif()
      else()
        if(EXISTS ${TEST_DIR}/lib)
          install(DIRECTORY ${TEST_DIR}/lib DESTINATION Externals/${SV_EXT_${project_name}_BIN_DIR})
	endif()
        if(EXISTS ${TEST_DIR}/bin)
          install(DIRECTORY ${TEST_DIR}/bin DESTINATION Externals/${SV_EXT_${project_name}_BIN_DIR})
	endif()
        if(EXISTS ${TEST_DIR}/include)
          install(DIRECTORY ${TEST_DIR}/include DESTINATION Externals/${SV_EXT_${project_name}_BIN_DIR})
	endif()
      endif()
    endif()
  endif()
...
function(ExternalProject_Install_CMake_NoSB project_name)
  ...
  if(NOT "${TEST_DIR}" STREQUAL "")
    if(${CMAKE_PROJECT_NAME}_ENABLE_DISTRIBUTION)
      if(EXISTS ${TEST_DIR}/lib)
        install(DIRECTORY ${TEST_DIR}/lib DESTINATION Externals)
      endif()
      if(EXISTS ${TEST_DIR}/bin)
        install(DIRECTORY ${TEST_DIR}/bin DESTINATION Externals)
      endif()
    else()
      if(EXISTS ${TEST_DIR}/lib)
        install(DIRECTORY ${TEST_DIR}/lib DESTINATION Externals/${SV_EXT_${project_name}_BIN_DIR})
