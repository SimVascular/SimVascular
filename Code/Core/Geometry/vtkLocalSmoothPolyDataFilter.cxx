/*=========================================================================
  ...
  Module:    vtkLocalSmoothPolyDataFilter.cxx
...
vtkStandardNewMacro(vtkLocalSmoothPolyDataFilter);
...
class vtkLocalSmoothPoints { //;prevent man page generation
public:
  vtkLocalSmoothPoints();
  ~vtkLocalSmoothPoints()
    {
    delete [] this->Array;
    };
...
vtkLocalSmoothPoints::vtkLocalSmoothPoints()
{
  this->MaxId = -1;
...
vtkSmoothPoint *vtkLocalSmoothPoints::Resize(vtkIdType sz)
{
...
// The following code defines methods for the vtkLocalSmoothPolyDataFilter class
//
...
void vtkLocalSmoothPolyDataFilter::SetSourceData(vtkPolyData *source)
{
  this->SetInputData(1, source);
}

vtkPolyData *vtkLocalSmoothPolyDataFilter::GetSource()
{
...
int vtkLocalSmoothPolyDataFilter::RequestData(
  ...
  vtkInformationVector *outputVector)
{
  ...
  if ( source )
    {
      this->SmoothPoints = new vtkLocalSmoothPoints;
      vtkSmoothPoint *sPtr;
...
int vtkLocalSmoothPolyDataFilter::FillInputPortInformation(int port,
                                                      vtkInformation *info)
{
...
void vtkLocalSmoothPolyDataFilter::PrintSelf(ostream& os, vtkIndent indent)
{
...
int vtkLocalSmoothPolyDataFilter::GetSmoothArrays(vtkPolyData *object, int type)
{
  vtkIdType i;
  int exists = 0;
  int numArrays;
...
int vtkLocalSmoothPolyDataFilter::SetFixedPoints(vtkPolyData *pd,int *fixedPoint)
{
