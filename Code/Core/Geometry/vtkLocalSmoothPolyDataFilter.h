/*=========================================================================
  ...
  Module:    vtkLocalSmoothPolyDataFilter.h
...
=========================================================================*/
// .NAME vtkLocalSmoothPolyDataFilter - adjust point positions using Laplacian smoothing
// .SECTION Description
// vtkLocalSmoothPolyDataFilter is a filter that adjusts point coordinates using
...
public:
  ...
  static vtkLocalSmoothPolyDataFilter *New();
...
protected:
  ...
  vtkLocalSmoothPoints *SmoothPoints;
private:
  vtkLocalSmoothPolyDataFilter(const vtkLocalSmoothPolyDataFilter&);  // Not implemented.
  void operator=(const vtkLocalSmoothPolyDataFilter&);  // Not implemented.
};
