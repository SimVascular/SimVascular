...
c #define MPI_AINT          ((MPI_Datatype)0x4c000843)
c
c int MPI_Type_extent(MPI_Datatype, MPI_Aint *);
c /* See the 1.1 version of the Standard.  The standard made an 
c   unfortunate choice here, however, it is the standard.  The size returned 
c   by MPI_Type_size is specified as an int, not an MPI_Aint */
c
c int MPI_Type_hvector(int, int, MPI_Aint, MPI_Datatype, MPI_Datatype *);
c int MPI_Type_indexed(int, int *, int *, MPI_Datatype, MPI_Datatype *);
c int MPI_Type_commit(MPI_Datatype *);

      subroutine MPI_Type_extent(i1,i2,ierror)
      ...
      subroutine MPI_Type_hvector(i1,i2,i3,i4,i5,ierror)
      ...
      subroutine MPI_Type_indexed(i1,i2,i3,i4,i5,ierror)
      ...
      subroutine MPI_Type_commit(i1,ierror)
