...
c
c
        INTEGER numeqns(100), minIters, maxIters, iprjFlag, nPrjs, ipresPrjFlag
        INTEGER nPresPrjs,iverbose, maxNSIters, maxMomentumIters, maxContinuityIters
     ...
     &                  iverbose, maxNSIters, maxMomentumIters,
     &                  maxContinuityIters
