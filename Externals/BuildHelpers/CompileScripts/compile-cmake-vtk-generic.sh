...
REPLACEME_SV_CMAKE_CMD -G REPLACEME_SV_CMAKE_GENERATOR \
   ...
   -DFREETYPE_INCLUDE_DIR_freetype2:PATH=REPLACEME_SV_TOP_BIN_DIR_FREETYPE/include/freetype2 \
   -DFREETYPE_INCLUDE_DIR_ft2build:PATH=REPLACEME_SV_TOP_BIN_DIR_FREETYPE/include/freetype2 \
   -DFREETYPE_LIBRARY:FILEPATH=REPLACEME_SV_TOP_BIN_DIR_FREETYPE/lib/REPLACEME_SV_FREETYPE_LIBRARY \
