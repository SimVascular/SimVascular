rm -Rf ../../Code/MITKConfigWorkbenchBuild
mkdir -p ../../Code/MITKConfigWorkbenchBuild
pushd ../../Code/MITKConfigWorkbenchBuild
...
\
   ...
   -DMITK_DIR="$REPLACEME_SV_EXTERNALS_TOPLEVEL_DIR/build/mitk-2016.03/MITK-build" \
