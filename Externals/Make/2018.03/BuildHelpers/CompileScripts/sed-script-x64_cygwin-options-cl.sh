...
s+REPLACEME_SV_SPECIAL_TOP_BIN_DIR_PYTHON+REPLACEME_SV_SPECIAL_TOPLEVEL_BINDIR/REPLACEME_SV_COMPILER_SHORT_NAME/REPLACEME_SV_COMPILER_VER_NO/REPLACEME_SV_ARCH_DIR/REPLACEME_SV_LOWERCASE_CMAKE_BUILD_TYPE/REPLACEME_SV_PYTHON_DIR+g

#
# toplevel directories
#

s+REPLACEME_SV_FULLPATH_BUILDDIR+REPLACEME_SV_TOPLEVEL_BUILDDIR/REPLACEME_SV_COMPILER_SHORT_NAME/REPLACEME_SV_COMPILER_VER_NO/REPLACEME_SV_ARCH_DIR/REPLACEME_SV_LOWERCASE_CMAKE_BUILD_TYPE+g
s+REPLACEME_SV_FULLPATH_BINDIR+REPLACEME_SV_TOPLEVEL_BINDIR/REPLACEME_SV_COMPILER_SHORT_NAME/REPLACEME_SV_COMPILER_VER_NO/REPLACEME_SV_ARCH_DIR/REPLACEME_SV_LOWERCASE_CMAKE_BUILD_TYPE+g
#s+REPLACEME_SV_TOPLEVEL_SRCDIR+C:/cygwin64/usr/local/sv/ext/2018.03/src+g
s+REPLACEME_SV_TOPLEVEL_SRCDIR+S:+g
s+REPLACEME_SV_TOPLEVEL_BINDIR+C:/cygwin64/usr/local/sv/ext/2018.03/bin+g
s+REPLACEME_SV_SPECIAL_TOPLEVEL_BINDIR+C:\\cygwin64/usr/local/sv/ext/2018.03/bin+g
s+REPLACEME_NO_FIRST_SLASH_SV_TOPLEVEL_BINDIR+usr/local/sv/ext/2018.03/bin+g
#s+REPLACEME_SV_TOPLEVEL_BUILDDIR+C:/cygwin64/usr/local/sv/ext/build+g
s+REPLACEME_SV_TOPLEVEL_BUILDDIR+C:/sv18+g
...
s+REPLACEME_SV_SPECIAL_COMPILER_SCRIPT+source CygwinHelpers/msvc_2015_x64.sh;export PATH=/cygdrive/c/Program\\ Files/doxygen/bin:/cygdrive/c/Program\\ Files\\ \\(x86\\)/Graphviz2.38/bin:/cygdrive/c/Program\\ Files/CMake/bin:$PATH;subst S: C:/cygwin64/usr/local/sv/ext/2018.03/src+g
...
s+REPLACEME_SV_PYTHON_VERSION+2.7.13+g
s+REPLACEME_SV_PYTHON_FULL_VERSION+2.7.13+g
...
s+REPLACEME_SV_PYTHON_DIR+python-2.7.13+g
...
s+REPLACEME_SV_VTK_VERSION+vtk-8.0.0+g
s+REPLACEME_SV_VTK_DIR+vtk-8.0.0+g
s+REPLACEME_SV_VTK_CMAKE_LIB_DIR+lib/cmake/vtk-8.0+g
...
s+REPLACEME_SV_TCL_VERSION+8.6.8+g
s+REPLACEME_SV_TCLTK_DIR+tcltk-8.6.8+g
s+REPLACEME_SV_TCL_DIR+tcl-8.6.8+g
s+REPLACEME_SV_TCL_LIB_NAME+tcl86t.lib+g
s+REPLACEME_SV_TK_VERSION+8.6.8+g
s+REPLACEME_SV_TK_DIR+tk-8.6.8+g
...
s+REPLACEME_SV_ITK_VERSION+4.12.2+g
s+REPLACEME_SV_ITK_DIR+itk-4.12.2+g
s+REPLACEME_SV_ITK_INCLUDE_DIR+include/ITK-4.12+g
s+REPLACEME_SV_ITK_CMAKE_LIB_DIR+lib/cmake/ITK-4.12+g
s+REPLACEME_SV_ITK_MAKE_FILENAME+itk.sln+g

# opencascade

s+REPLACEME_SV_OPENCASCADE_VERSION+7.2.0+g
s+REPLACEME_SV_OPENCASCADE_DIR+opencascade-7.2.0+g
...
s+REPLACEME_SV_MITK_DIR+mitk-2018.02+g
s+REPLACEME_SV_MITK_CMAKE_LIB_DIR+lib/mitk-2018.02+g
