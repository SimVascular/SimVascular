...
# qt
s+REPLACEME_SV_QT5_DIR+REPLACEME_SV_TOP_BIN_DIR_QT/5.6.3/gcc_64+g
...
s+REPLACEME_SV_TOPLEVEL_SRCDIR+/usr/local/sv/ext/2018.05/REPLACEME_SV_LOWERCASE_CMAKE_BUILD_TYPE/src+g
s+REPLACEME_SV_TOPLEVEL_BINDIR+/usr/local/sv/ext/2018.05/REPLACEME_SV_LOWERCASE_CMAKE_BUILD_TYPE/bin+g
s+REPLACEME_NO_FIRST_SLASH_SV_TOPLEVEL_BINDIR+usr/local/sv/ext/2018.05/REPLACEME_SV_LOWERCASE_CMAKE_BUILD_TYPE/bin+g
s+REPLACEME_SV_TOPLEVEL_BUILDDIR+/usr/local/sv/ext/2018.05/REPLACEME_SV_LOWERCASE_CMAKE_BUILD_TYPE/build+g
s+REPLACEME_SV_SPECIAL_TOPLEVEL_BINDIR+/usr/local/sv/ext/2018.05/REPLACEME_SV_LOWERCASE_CMAKE_BUILD_TYPE/bin+g
#
#
#
...
s/REPLACEME_CXX/g++/g
s+REPLACEME_CMAKE_C_COMPILER+-DCMAKE_C_COMPILER:FILEPATH=/usr/bin/gcc-4.9+g
s"REPLACEME_CMAKE_CXX_COMPILER"-DCMAKE_CXX_COMPILER:FILEPATH=/usr/bin/g++-4.9"g
...
s+REPLACEME_SV_OPENSSL_LIBRARIES+"libssl.so;libcrypto.so"+g
...
# Qt
#s+REPLACEME_SV_QT5_DIR+/opt/Qt5.6.3/5.6.3/gcc_64+g
...
s+REPLACEME_SV_MITK_DIR+mitk-2018.04+g
s+REPLACEME_SV_MITK_CMAKE_LIB_DIR+lib/mitk-2018.04+g
