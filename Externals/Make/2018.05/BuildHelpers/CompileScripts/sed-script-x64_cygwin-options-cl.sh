...
s+REPLACEME_SV_TOPLEVEL_BINDIR+C:/cygwin64/usr/local/sv/ext/2018.05/REPLACEME_SV_LOWERCASE_CMAKE_BUILD_TYPE/bin+g
s+REPLACEME_SV_SPECIAL_TOPLEVEL_BINDIR+C:\\cygwin64/usr/local/sv/ext/2018.05/REPLACEME_SV_LOWERCASE_CMAKE_BUILD_TYPE/bin+g
