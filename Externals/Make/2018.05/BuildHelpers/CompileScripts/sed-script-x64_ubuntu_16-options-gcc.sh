...
s+REPLACEME_SV_PYTHON_INCLUDE_DIR+include/python3.5+g
s+REPLACEME_SV_PYTHON_EXECUTABLE+bin/python-wrapper+g
s+REPLACEME_SV_PYTHON_LIBRARY+lib/libpython3.5.so+g
s+REPLACEME_SV_PYTHON_LIB_NAME+libpython3.5.so+g
...
s+REPLACEME_SV_QT_DIR+qt-5.4.2+g
