...
# needed for SimpleITK buld
mkdir -p REPLACEME_SV_TOP_BLD_DIR_MITK/ep/lib/pythonREPLACEME_SV_PYTHON_MAJOR_VERSION.REPLACEME_SV_PYTHON_MINOR_VERSION/site-packages
mkdir -p REPLACEME_SV_TOP_BLD_DIR_MITK/ep/lib/site-packages
...
REPLACEME_SV_CMAKE_CMD -G REPLACEME_SV_CMAKE_GENERATOR \
  ...
  -DMITK_ADDITIONAL_CXX_FLAGS:STRING="-fpermissive -DVCL_CAN_STATIC_CONST_INIT_FLOAT=0 -isystem /usr/local/sv/ext/2022.09/release/gl2/bin/gnu/7.5/x64/gdcm-2.6.3/include/gdcm-2.6/" \
  -DMITK_ADDITIONAL_C_FLAGS:STRING="-fpermissive -DVCL_CAN_STATIC_CONST_INIT_FLOAT=0 -isystem /usr/local/sv/ext/2022.09/release/gl2/bin/gnu/7.5/x64/gdcm-2.6.3/include/gdcm-2.6/" \
   REPLACEME_CMAKE_C_COMPILER \
   REPLACEME_CMAKE_CXX_COMPILER \
  -DCMAKE_VERBOSE_MAKEFILE:BOOL=ON \
\
  -DGDCM_DIR:PATH=REPLACEME_SV_TOP_BIN_DIR_GDCM/REPLACEME_SV_GDCM_CMAKE_LIB_DIR \
  ...
  -DEXTERNAL_Numpy_DIR:PATH=REPLACEME_SV_TOP_BIN_DIR_PYTHON/lib/pythonREPLACEME_SV_PYTHON_MAJOR_VERSION.REPLACEME_SV_PYTHON_MINOR_VERSION/site-packages/numpy \
\
...
\
  ...
  -D_Python3_EXECUTABLE:FILEPATH=REPLACEME_SV_TOP_BIN_DIR_PYTHON/REPLACEME_SV_PYTHON_EXECUTABLE \
  -D_Python3_INCLUDE_DIR:PATH=REPLACEME_SV_TOP_BIN_DIR_PYTHON/REPLACEME_SV_PYTHON_INCLUDE_DIR \
  -DPYTHON_INCLUDE_DIR2:PATH=REPLACEME_SV_TOP_BIN_DIR_PYTHON/REPLACEME_SV_PYTHON_INCLUDE_DIR \
  -DPYTHON_LIBRARIES:FILEPATH=REPLACEME_SV_TOP_BIN_DIR_PYTHON/REPLACEME_SV_PYTHON_LIBRARY \
