...
# #install pytorch
# REPLACEME_SV_TOP_BIN_DIR_PYTHON/bin/pip install pytorch==1.12.1
...
#must install torando-5.1.1 since tornado-6.0.1 breaks jupyter!!
REPLACEME_SV_TOP_BIN_DIR_PYTHON/bin/pip install tornado
#install numpy
REPLACEME_SV_TOP_BIN_DIR_PYTHON/bin/pip install numpy
#install jupyter
REPLACEME_SV_TOP_BIN_DIR_PYTHON/bin/pip install jupyter
#install pytorch
REPLACEME_SV_TOP_BIN_DIR_PYTHON/bin/pip install torch
#install pwlf for 1-D python code
REPLACEME_SV_TOP_BIN_DIR_PYTHON/bin/pip install pwlf
#install scipy for 1-D python code
REPLACEME_SV_TOP_BIN_DIR_PYTHON/bin/pip install scipy
#install pydoe for 1-D python code
REPLACEME_SV_TOP_BIN_DIR_PYTHON/bin/pip install pydoe
#install pyyaml needed for ML
REPLACEME_SV_TOP_BIN_DIR_PYTHON/bin/pip install pyyaml
