...
# qt
s+REPLACEME_SV_QT5_DIR+REPLACEME_SV_TOP_BIN_DIR_QT/5.11.3/clang_64+g
...
s+REPLACEME_SV_OS_VER_NO+10.13+g
...
s+REPLACEME_SV_SQLITE3_LIBRARY+libsqlite3.dylib+g
...
s+REPLACEME_SV_PYTHON_LIBRARY+lib/libpython3.5m.dylib+g
s+REPLACEME_SV_PYTHON_LIB_NAME+libpython3.5m.dylib+g
...
# Qt
#s+REPLACEME_SV_QT5_DIR+/usr/local/package/Qt5.11.3/5.11.3/clang_64+g
