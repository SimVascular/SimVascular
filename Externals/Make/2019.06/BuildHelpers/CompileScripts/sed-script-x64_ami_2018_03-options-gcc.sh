...
# qt
s+REPLACEME_SV_QT5_DIR+REPLACEME_SV_TOP_BIN_DIR_QT/5.12.3/gcc_64+g
...
# Qt
#s+REPLACEME_SV_QT5_DIR+/opt/Qt5.12.3/5.12.3/gcc_64+g
s+REPLACEME_SV_QT_DIR+qt-5.12.3+g
s+REPLACEME_SV_QT_VERSION+5.12.3+g
