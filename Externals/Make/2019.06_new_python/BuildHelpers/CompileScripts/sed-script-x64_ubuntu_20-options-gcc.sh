...
s+REPLACEME_CC+gcc-8+g
s/REPLACEME_CXX/g++-8/g
...
s+REPLACEME_SV_CMAKE_CMD+/home/luca/tmp/cmake/build/bin/cmake+g
...
s+REPLACEME_SV_PYTHON_INCLUDE_DIR+include/python3.9m+g
s+REPLACEME_SV_PYTHON_EXECUTABLE+bin/svpython+g
s+REPLACEME_SV_PYTHON_LIBRARY+lib/libpython3.9m.so+g
s+REPLACEME_SV_PYTHON_LIB_NAME+libpython3.9m.so+g
