...
# qt
s+REPLACEME_SV_QT5_DIR+REPLACEME_SV_TOP_BIN_DIR_QT+g
...
s+REPLACEME_SV_TOP_BIN_DIR_QT+REPLACEME_SV_FULLPATH_BINDIR/qt-5.14.2+g
# gdcm
...
s+REPLACEME_SV_TOPLEVEL_SRCDIR+/usr/local/sv/ext/2022.10/REPLACEME_SV_LOWERCASE_CMAKE_BUILD_TYPE/REPLACEME_SHORT_GL_NAME/src+g
s+REPLACEME_SV_TOPLEVEL_BINDIR+/usr/local/sv/ext/2022.10/REPLACEME_SV_LOWERCASE_CMAKE_BUILD_TYPE/REPLACEME_SHORT_GL_NAME/bin+g
s+REPLACEME_SV_SPECIAL_TOPLEVEL_BINDIR+/usr/local/sv/ext/2022.10/REPLACEME_SV_LOWERCASE_CMAKE_BUILD_TYPE/REPLACEME_SHORT_GL_NAME/bin+g
s+REPLACEME_NO_FIRST_SLASH_SV_TOPLEVEL_BINDIR+usr/local/sv/ext/2022.10/REPLACEME_SV_LOWERCASE_CMAKE_BUILD_TYPE/REPLACEME_SHORT_GL_NAME/bin+g
...
s+REPLACEME_SV_TOPLEVEL_BUILDDIR+/usr/local/sv/ext/2022.10/REPLACEME_SV_LOWERCASE_CMAKE_BUILD_TYPE/REPLACEME_SHORT_GL_NAME/build+g
...
s+REPLACEME_SV_HDF5_DIR+hdf5-1.12.2+g
...
s+REPLACEME_SV_PYTHON_VERSION+3.9.10+g
s+REPLACEME_SV_PYTHON_MAJOR_VERSION+3+g
s+REPLACEME_SV_PYTHON_MINOR_VERSION+9+g
s+REPLACEME_SV_PYTHON_PATCH_VERSION+10+g
s+REPLACEME_SV_PYTHON_FULL_VERSION+3.9.10+g
s+REPLACEME_SV_PYTHON_INCLUDE_DIR+include/python3.9+g
s+REPLACEME_SV_PYTHON_EXECUTABLE+bin/svpython+g
s+REPLACEME_SV_PYTHON_LIBRARY+lib/libpython3.9.so+g
s+REPLACEME_SV_PYTHON_LIB_NAME+libpython3.9.so+g
s+REPLACEME_SV_PYTHON_DIR+python-3.9.10+g
...
s+REPLACEME_SV_VTK_VERSION+vtk-9.2.0+g
s+REPLACEME_SV_VTK_DIR+vtk-9.2.0+g
s+REPLACEME_SV_VTK_CMAKE_LIB_DIR+lib/cmake/vtk-9.2+g
...
s+REPLACEME_SV_QT_DIR+qt-5.14.2/5.14.2/gcc_64+g
s+REPLACEME_SV_QT_VERSION+5.14.2+g
s+REPLACEME_SV_QMAKE_EXECUTABLE+/bin/qmake+g
...
s+REPLACEME_SV_ITK_VERSION+5.2.1+g
s+REPLACEME_SV_ITK_DIR+itk-5.2.1+g
s+REPLACEME_SV_ITK_INCLUDE_DIR+include/ITK-5.2+g
s+REPLACEME_SV_ITK_CMAKE_LIB_DIR+lib/cmake/ITK-5.2+g
s+REPLACEME_SV_ITK_MAKE_FILENAME++g

# opencascade

s+REPLACEME_SV_OPENCASCADE_VERSION+7.6.0+g
s+REPLACEME_SV_OPENCASCADE_DIR+opencascade-7.6.0+g
...
s+REPLACEME_SV_MITK_DIR+mitk-2022.09.27+g
s+REPLACEME_SV_MITK_CMAKE_LIB_DIR+lib/mitk-2022.09.27+g
