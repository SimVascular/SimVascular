...
REPLACEME_SV_CMAKE_CMD -G REPLACEME_SV_CMAKE_GENERATOR \
   ...
   -DVTK_WRAP_TCL=1 \
   -DVTK_QT_VERSION=5 \
   -DVTK_RENDERING_BACKEND=REPLACEME_SV_VTK_OPENGL_VERSION \
   ...
   -DPython3_EXECUTABLE:FILEPATH=REPLACEME_SV_TOP_BIN_DIR_PYTHON/REPLACEME_SV_PYTHON_EXECUTABLE \
   -DPython3_INCLUDE_DIR:FILEPATH=REPLACEME_SV_TOP_BIN_DIR_PYTHON/REPLACEME_SV_PYTHON_INCLUDE_DIR \
   -DPython3_LIBRARY:FILEPATH=REPLACEME_SV_TOP_BIN_DIR_PYTHON/REPLACEME_SV_PYTHON_LIBRARY \
   ...
   -DQt5WebEngineWidgets_DIR=REPLACEME_SV_QT5_DIR/lib/cmake/Qt5WebEngineWidgets \
   -DQt5WebEngine_DIR=REPLACEME_SV_QT5_DIR/lib/cmake/Qt5WebEngine \
   ...
   -DQT_QMAKE_EXECUTABLE=REPLACEME_SV_QT5_DIR/bin/REPLACEME_SV_QMAKE_EXECUTABLE \
