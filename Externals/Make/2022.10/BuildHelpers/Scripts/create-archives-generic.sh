...
if [[ $SV_SUPER_OPTIONS == *ARCHIVE_SWIG* ]]; then
  echo "ARCHIVE_SWIG"
  pushd REPLACEME_SV_FULLPATH_BINDIR
  REPLACEME_TAR -cvzf $SV_TAR_FILE_PREFIX.REPLACEME_SV_SWIG_VERSION_DIR.tar.gz REPLACEME_SV_SWIG_VERSION_DIR
  popd
  mv REPLACEME_SV_FULLPATH_BINDIR/$SV_TAR_FILE_PREFIX.REPLACEME_SV_SWIG_VERSION_DIR.tar.gz tar_output
fi
...
# tinyxml2
if [[ $SV_SUPER_OPTIONS == *ARCHIVE_TINYXML2* ]]; then
  echo "ARCHIVE_TINYXML2"
  pushd REPLACEME_SV_FULLPATH_BINDIR
  REPLACEME_TAR -cvzf $SV_TAR_FILE_PREFIX.REPLACEME_SV_TINYXML2_DIR.tar.gz REPLACEME_SV_TINYXML2_DIR
  popd
  mv REPLACEME_SV_FULLPATH_BINDIR/$SV_TAR_FILE_PREFIX.REPLACEME_SV_TINYXML2_DIR.tar.gz tar_output
fi
...
if [[ $SV_SUPER_OPTIONS == *ARCHIVE_QT* ]]; then
  echo "ARCHIVE_QT"
  pushd REPLACEME_SV_FULLPATH_BINDIR
  echo REPLACEME_TAR -cvzf $SV_TAR_FILE_PREFIX.qt-REPLACEME_SV_QT_VERSION.tar.gz REPLACEME_SV_QT_DIR
  REPLACEME_TAR -cvzf $SV_TAR_FILE_PREFIX.qt-REPLACEME_SV_QT_VERSION.tar.gz REPLACEME_SV_QT_DIR
  popd
  echo REPLACEME_SV_FULLPATH_BINDIR/$SV_TAR_FILE_PREFIX.qt-REPLACEME_SV_QT_VERSION.tar.gz tar_output
  mv REPLACEME_SV_FULLPATH_BINDIR/$SV_TAR_FILE_PREFIX.qt-REPLACEME_SV_QT_VERSION.tar.gz tar_output
fi
