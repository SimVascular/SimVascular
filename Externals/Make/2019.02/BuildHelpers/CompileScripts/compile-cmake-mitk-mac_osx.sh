...
REPLACEME_SV_CMAKE_CMD -G REPLACEME_SV_CMAKE_GENERATOR \
  ...
  -DCMAKE_CXX_FLAGS:STRING="-DVCL_CAN_STATIC_CONST_INIT_FLOAT=0" \
  -DCMAKE_C_FLAGS:STRING="-DVCL_CAN_STATIC_CONST_INIT_FLOAT=0" \
...
\
  ...
  -DPYTHON_INCLUDE_DIRS:PATH=REPLACEME_SV_TOP_BIN_DIR_PYTHON/REPLACEME_SV_PYTHON_INCLUDE_DIR \
