...
echo "if [ -z \${PYTHONPATH+x} ]; then" >> REPLACEME_SV_TOP_BIN_DIR_PYTHON/bin/python-wrapper 
echo "  OLDPYTHONPATH=\"\"" >> REPLACEME_SV_TOP_BIN_DIR_PYTHON/bin/python-wrapper 
echo "else" >> REPLACEME_SV_TOP_BIN_DIR_PYTHON/bin/python-wrapper
echo "  OLDPYTHONPATH=\$PYTHONPATH" >> REPLACEME_SV_TOP_BIN_DIR_PYTHON/bin/python-wrapper
echo "  OLDPYTHONPATH=\${PYTHONPATH//;/:/}" >> REPLACEME_SV_TOP_BIN_DIR_PYTHON/bin/python-wrapper
...
echo "export LD_LIBRARY_PATH=$PYTHONHOME/lib:$LD_LIBRARY_PATH" >> REPLACEME_SV_TOP_BIN_DIR_PYTHON/bin/python-wrapper
...
echo "  REPLACEME_SV_TOP_BIN_DIR_PYTHON/bin/pythonREPLACEME_SV_PYTHON_MAJOR_VERSION.REPLACEME_SV_PYTHON_MINOR_VERSION " >> REPLACEME_SV_TOP_BIN_DIR_PYTHON/bin/python-wrapper
echo "elif [ \"\$#\" -eq 1 ]; then" >> REPLACEME_SV_TOP_BIN_DIR_PYTHON/bin/python-wrapper
echo "  REPLACEME_SV_TOP_BIN_DIR_PYTHON/bin/pythonREPLACEME_SV_PYTHON_MAJOR_VERSION.REPLACEME_SV_PYTHON_MINOR_VERSION \"\$1\" " >> REPLACEME_SV_TOP_BIN_DIR_PYTHON/bin/python-wrapper
echo "elif [ \"\$#\" -eq 2 ]; then" >> REPLACEME_SV_TOP_BIN_DIR_PYTHON/bin/python-wrapper
echo "  REPLACEME_SV_TOP_BIN_DIR_PYTHON/bin/pythonREPLACEME_SV_PYTHON_MAJOR_VERSION.REPLACEME_SV_PYTHON_MINOR_VERSION \"\$1\" \"\$2\" " >> REPLACEME_SV_TOP_BIN_DIR_PYTHON/bin/python-wrapper
echo "elif [ \"\$#\" -eq 3 ]; then" >> REPLACEME_SV_TOP_BIN_DIR_PYTHON/bin/python-wrapper
echo "  REPLACEME_SV_TOP_BIN_DIR_PYTHON/bin/pythonREPLACEME_SV_PYTHON_MAJOR_VERSION.REPLACEME_SV_PYTHON_MINOR_VERSION \"\$1\" \"\$2\" \"\$3\" " >> REPLACEME_SV_TOP_BIN_DIR_PYTHON/bin/python-wrapper
echo "else" >> REPLACEME_SV_TOP_BIN_DIR_PYTHON/bin/python-wrapper
echo "  REPLACEME_SV_TOP_BIN_DIR_PYTHON/bin/pythonREPLACEME_SV_PYTHON_MAJOR_VERSION.REPLACEME_SV_PYTHON_MINOR_VERSION \"\$1\" \"\$2\" \"\$3\" \"\${@:4}\" " >> REPLACEME_SV_TOP_BIN_DIR_PYTHON/bin/python-wrapper
echo "fi" >> REPLACEME_SV_TOP_BIN_DIR_PYTHON/bin/python-wrapper
